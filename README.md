Reads SVG from STDIN, prints it to STDOUT with all `path/@d`s "minified" by rounding all coordinates to *N* decimals (N can be specified with the first argument, defaults to 0 (=round to integer)).   
